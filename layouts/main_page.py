...
def build_banner(app):
    ...
    return dbc.Navbar(dbc.Container(id="main_page_container", children=[
        dbc.Col(html.Img(id="banner_logo", src=app.get_asset_url("logo.PNG")), width=3),
        # dbc.Col([html.H5("Dashboard"), 
        #          html.H6("Tag line goes here")]),
        dbc.Col(width=5),
        html.Datalist(id='list_suggested_inputs', children=options),
        dbc.Col(dbc.Input(type="search", placeholder="Search", list="list_suggested_inputs"), width=2),
        dbc.Col(
        ...
        color="dark", dark=True, className="banner")
...
def build_tabs():
    return html.Div(id="tabs", className="tabs", children=[
                dcc.Tabs(id='main_tabs', value = 'tab2', children=[
